...
CREATE TABLE `session_results` (
  ...
  CONSTRAINT `session_results_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`student_id`),
  CONSTRAINT `session_results_ibfk_2` FOREIGN KEY (`subject_id`) REFERENCES `subject` (`subject_id`)
...
INSERT INTO `session_results` VALUES (1,1,15,2),(2,1,20,5),(3,2,9,3);
